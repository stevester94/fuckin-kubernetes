...
read -p "Press any ket to install kubelet et. al. "
...
read -p "Press any key to enable kubelet "
sudo systemctl enable --now kubelet

read -p "Press any key to kubeadm init "
sudo kubeadm init
...
read -p "Press any key to install weave"
